...
sNext:"Suivant",sPrevious:"Précédant"},sEmptyTable:"Pas de donnée à afficher",sInfo:"On voit de _START_ à _END_ sur _TOTAL_ entrées au total",sInfoEmpty:"On voit de 0 à 0 sur 0 entrée",sInfoFiltered:"(filtré de _MAX_ entrées totales)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Montrer _MENU_ entrées",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Rechercher:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucune donnée correspondante trouvée"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
